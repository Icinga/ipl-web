define(["../notjQuery"], function ($) {
    ...
    class ActionList {
        ...
        /** @type {bool} Whether the list should be considered as a primary list */
        #isPrimary = false;

        /** @type {bool} Whether the list selection is in process */
        #processing = false;

        /** @type {bool} Whether the list supports multi-selection */
        #isMultiSelectable = false;

        /** @type {bool} Whether the list is set to `display: contents` */
        #isDisplayContents = false;

        /** @type {?url} The url of last active item */
        #lastActivatedItemUrl = null;

        /** @type {?int} The timeout id */
        #lastTimeoutId = null;
        ...
        addSelectionCountToFooter() {
            if (! this.#footer || ! this.#isMultiSelectable || ! this.#isPrimary) {
                return;
            }
